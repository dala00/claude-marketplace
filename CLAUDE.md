...
### business-idea-check プラグイン

ビジネスアイデアの実現可能性・収益性を多角的に判定するスキル。

```
business-idea-check         ← ビジネスアイデア判定（ターゲット層、収益性、集客、開発可能性、収支、倫理面を5段階評価）
```

- ユーザーが入力したビジネスアイデアを6つ以上の観点で分析・スコアリング
- 情報不足の場合は追加ヒアリングを実施
- 総合判定（成功可能性 高・中・低）と改善アドバイスを提示
